...
export type BlogPost = {
  ...
  date: string;
  tags: string[];
  thumbnail: { bg: string; emoji: string };
  content: string;
};
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    date: "2026-04-01",
    tags: ["리뷰", "자동화", "네이버"],
    thumbnail: { bg: "linear-gradient(135deg, #1a1a2e, #16213e)", emoji: "⭐" },
...
> 일프로AI PRO 플랜(₩29,900/월)에 포함된 기능입니다.`,
  },
  {
    ...
    subtitle: "업종과 분위기만 선택하면 인스타그램, 블로그, 페이스북 게시물이 한 번에.",
    icon: "📣",
    readTime: "4분",
    date: "2026-04-02",
    tags: ["SNS", "마케팅", "인스타그램"],
    thumbnail: { bg: "linear-gradient(135deg, #2d1b42, #1a1a2e)", emoji: "📣" },
...
회원가입만 하면 **무료로 SNS 콘텐츠 생성을 체험**할 수 있습니다. 지금 바로 [대시보드](/dashboard)에서 시도해보세요!`,
  },
  {
    ...
    date: "2026-04-03",
    tags: ["예약", "운영", "노쇼방지"],
    thumbnail: { bg: "linear-gradient(135deg, #1a2a1a, #162e16)", emoji: "📋" },
    content: `## 예약 관리의 현실
...
예약 관리는 **무료 플랜**에 포함되어 있습니다. 지금 바로 사용해보세요.`,
  },
  {
    ...
    date: "2026-04-04",
    tags: ["매출", "분석", "리포트"],
    thumbnail: { bg: "linear-gradient(135deg, #1e2a1a, #1a2e20)", emoji: "📊" },
...
리포트를 PDF로 내보내서 세무사에게 바로 공유할 수 있습니다.`,
  },
  {
    ...
    date: "2026-04-05",
    tags: ["견적서", "PDF", "영업"],
    thumbnail: { bg: "linear-gradient(135deg, #1a1a2e, #1e2636)", emoji: "💼" },
...
> 견적서 기능은 **무료 플랜**에서 사용 가능합니다.`,
  },
  {
    ...
    date: "2026-04-06",
    tags: ["챗봇", "카카오톡", "고객응대"],
    thumbnail: { bg: "linear-gradient(135deg, #1a1a2e, #2e1a2e)", emoji: "💬" },
...
- PRO 플랜(₩29,900/월)에 포함`,
  },
  {
    ...
    date: "2026-04-07",
    tags: ["홈페이지", "AI", "웹사이트"],
    thumbnail: { bg: "linear-gradient(135deg, #162e3e, #1a2636)", emoji: "🌐" },
...
PRO 플랜(₩29,900/월)에 포함. 별도 호스팅 비용 없음.`,
  },
  {
    ...
    date: "2026-04-08",
    tags: ["급여", "인사관리", "파트타임"],
    thumbnail: { bg: "linear-gradient(135deg, #2e1a2e, #1a1a2e)", emoji: "👥" },
    content: `## 급여 계산의 고통
...
> 급여 관리는 **무료 플랜**에서 사용 가능합니다.`,
  },
  {
    ...
    date: "2026-04-09",
    tags: ["CRM", "고객관리", "연락처"],
    thumbnail: { bg: "linear-gradient(135deg, #1a2636, #1a1a2e)", emoji: "👤" },
...
> 연락처 관리는 **무료 플랜**에서 사용 가능합니다.`,
  },
  {
    ...
    date: "2026-04-10",
    tags: ["세금계산서", "세무", "자동화"],
    thumbnail: { bg: "linear-gradient(135deg, #2e2a1a, #1a1a16)", emoji: "📄" },
...
예약 부도(노쇼)율 전국 평균 **15~20%**. 4인 테이블 하나가 빈다면 하루 매출 80,000원 손실입니다.
...
- PRO 플랜(₩29,900/월)에 포함`,
  },
  {
    ...
    date: "2026-04-12",
    tags: ["AI", "인사이트", "경영분석"],
    thumbnail: { bg: "linear-gradient(135deg, #1a1a2e, #2e1a3e)", emoji: "💡" },
  ...
  return (
    <div className="min-h-screen" style={{ background: "#fafafa" }}>
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl" style={{ background: "rgba(250,250,250,0.9)", borderBottom: "1px solid #eee" }}>
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/" className="text-sm text-[#888] hover:text-[#111] transition-colors" style={{ textDecoration: "none" }}>홈</Link>
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-10">
        {/* Hero — simple */}
        <div className="mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-[#111] mb-2">소상공인 AI 가이드</h1>
          <p className="text-[#888] text-base">일프로AI로 시간과 비용을 절약하는 방법</p>
        </div>

        {/* Category filter — pill style, muted */}
        ...
        {/* Featured post — full width, dark, with large thumbnail */}
        {category === "전체" && (
          <Link href={`/blog/${BLOG_POSTS[11].slug}`} className="block mb-10 group" style={{ textDecoration: "none" }}>
            <div className="rounded-2xl overflow-hidden flex flex-col md:flex-row" style={{ background: "#111" }}>
              {/* Thumbnail */}
              <div className="md:w-1/2 aspect-[16/9] md:aspect-auto flex items-center justify-center relative"
                style={{ background: BLOG_POSTS[11].thumbnail.bg, minHeight: 280 }}>
                <span className="text-8xl opacity-30">{BLOG_POSTS[11].thumbnail.emoji}</span>
                <div className="absolute inset-0 opacity-5" style={{ backgroundImage: "radial-gradient(circle at 30% 50%, rgba(255,255,255,0.3), transparent 60%)" }} />
              </div>
              {/* Content */}
        ...
        {/* Blog grid — 2 cols on md, 3 on lg, 4 on xl */}
          ...
          {filtered.map((post) => (
            <Link key={post.slug} href={`/blog/${post.slug}`}
              ...
              <div className="aspect-[16/10] flex items-center justify-center relative overflow-hidden"
                style={{ background: post.thumbnail.bg }}>
                <span className="text-5xl opacity-40 group-hover:opacity-60 group-hover:scale-110 transition-all duration-300">
                  {post.thumbnail.emoji}
                </span>
                <div className="absolute inset-0 opacity-5" style={{ backgroundImage: "radial-gradient(circle at 30% 50%, rgba(255,255,255,0.4), transparent 60%)" }} />
              </div>
              {/* Text */}
              <div className="p-4">
        ...
        <div className="mt-16 text-center py-12 rounded-2xl" style={{ background: "#111" }}>
          ...
          <p className="text-sm text-[#666] mb-6">무료 플랜으로 모든 기본 기능을 사용할 수 있습니다</p>
